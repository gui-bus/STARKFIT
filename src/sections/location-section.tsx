      ...
      <div className="w-full max-w-400 mx-auto px-8 md:px-16 lg:px-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-32 items-center">
                ...
                >
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <span className="px-3 py-1 bg-primary text-black text-[8px] font-black uppercase tracking-widest rounded-sm">
                        {loc.tag}
                      </span>
                      <p className="text-primary font-bold tracking-widest text-xs uppercase italic">
                        {loc.neighborhood}
                      </p>
                    </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative z-10 w-full aspect-[4/5]  rounded-[5rem] border-8 border-white/5 overflow-hidden shadow-[0_50px_100px_-20px_rgba(156,209,90,0.2)]">
              <Image
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="p-10 rounded-full border-2 border-primary/20 backdrop-blur-md /40">
