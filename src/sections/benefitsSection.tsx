            ...
            >
              <div className="flex-1 space-y-12">
                <div className="flex items-center gap-8">
                  <span className="text-primary/20 font-black text-6xl md:text-8xl italic group-hover:text-primary transition-all duration-700">
                    0{index + 1}
                  </span>
                  <div className="h-px flex-1 bg-white/10" />
                  <span className="px-8 py-2.5 rounded-full border border-white/10 text-[9px] font-black uppercase tracking-[0.4em] text-white/30 group-hover:text-white/60 transition-colors">
                    {benefit.tag}
                  </span>
                </div>
              ...
              <div className="flex-1 w-full relative">
                ...
                <div
                  className={`absolute -z-10 ${index % 2 === 0 ? "-right-16" : "-left-16"} -bottom-16 w-80 h-80 bg-primary/5 blur-[120px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-1000`}
                />
              </div>
            </motion.div>
          ))}
