...
const stats = [
  {
    label: "Membros Elite",
    value: "5k+",
    icon: <UsersIcon weight="bold" className="text-primary w-6 h-6" />,
  },
  {
    label: "Unidades",
    value: "12",
    icon: <BuildingsIcon weight="bold" className="text-primary w-6 h-6" />,
  },
  {
    label: "Performance",
    value: "100%",
    icon: <LightningIcon weight="bold" className="text-primary w-6 h-6" />,
  },
  {
    label: "Resultados",
    value: "Focado",
    icon: <TargetIcon weight="bold" className="text-primary w-6 h-6" />,
  },
];

const AboutSection = () => {
  return (
    <section id="About" className="py-48  overflow-hidden relative">
      <div className="w-full max-w-400 mx-auto px-8 md:px-16 lg:px-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-32 items-center">
          ...
          >
            <div className="relative z-10 w-full aspect-[4/5] bg-white/5 rounded-[4.5rem] overflow-hidden border border-white/10 shadow-[0_50px_100px_rgba(0,0,0,0.8)]">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center">
                <p className="text-8xl font-black text-white/5 uppercase select-none leading-none mb-6 tracking-tighter">
                  DISCIPLINE
                </p>
                <div className="px-8 py-3 rounded-full border border-primary/30 backdrop-blur-md bg-primary/5 shadow-2xl">
                  <p className="text-sm font-black text-primary italic uppercase tracking-[0.5em]">
                    O Legado é a Força
                  </p>
                </div>
              </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="space-y-16 order-1 lg:order-2 text-left"
          >
            <div className="space-y-8">
              <div className="flex items-center gap-4 text-primary">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.5em]">
                  Cultura Global Stark
                </span>
              </div>
              <h2 className="text-7xl md:text-[9.5rem] font-black uppercase text-white leading-[0.8] tracking-tighter font-sans">
                ALÉM DA <br />{" "}
                <span className="text-primary italic">BIOLOGIA.</span>
              </h2>
              <p className="text-2xl text-white/60 font-medium leading-relaxed uppercase italic border-l-4 border-primary pl-10">
                A StarkFit é um laboratório de evolução. Nossos membros não
                buscam apenas estética, buscam o ápice do potencial humano
                através de esforço bruto.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-8">
              {stats.map((stat, i) => (
                <div
                  key={i}
                  className="bg-white/5 p-10 rounded-[3rem] border border-white/5 hover:border-primary/30 transition-all duration-500 group shadow-2xl"
                >
                  <div className="flex items-center gap-5 mb-5">
                    <div className="p-3.5  rounded-2xl border border-white/10 group-hover:bg-primary transition-all duration-500 shadow-xl group-hover:scale-110">
                  ...
                  <p className="text-[10px] uppercase font-black tracking-[0.4em] text-white/30 group-hover:text-primary transition-colors">
                    {stat.label}
                  </p>
                </div>
              ))}
            ...
            <div className="pt-10">
              <button className="flex items-center gap-6 group outline-none">
                ...
                <div className="space-y-1">
                  <p className="text-white font-black italic uppercase tracking-widest leading-none text-lg">
