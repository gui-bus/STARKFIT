...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-400 mx-auto px-8 md:px-16 lg:px-24 relative z-10 pt-20">
        <div className="max-w-5xl space-y-14">
          ...
          >
            <div className="flex items-center gap-5">
              ...
              <span className="text-sm font-black tracking-[0.4em] text-primary uppercase italic">
            ...
            <h1 className="text-7xl md:text-[11rem] font-black leading-[0.8] tracking-tighter text-white uppercase">
              FORCE <br />
              <span className="text-primary drop-shadow-[0_0_40px_rgba(156,209,90,0.3)]">
                UNLEASHED.
              </span>
            </h1>
          </motion.div>
          ...
          >
            <Button
              size="lg"
              className="bg-primary text-white font-black text-sm tracking-widest px-14 py-10 rounded-full hover:bg-primary/80 transition-all shadow-[0_15px_50px_-10px_rgba(156,209,90,0.5)] active:scale-95 border-none uppercase"
            >
              QUERO TREINAR AGORA
            </Button>
            <button className="flex items-center gap-5 group outline-none">
              ...
              <span className="text-xs font-black uppercase tracking-[0.3em] text-white/40 group-hover:text-white transition-colors">
                Ver Galeria
              </span>
            </button>
          </motion.div>
      ...
      <div className="absolute right-16 bottom-32 hidden 2xl:block space-y-12">
        <div className="flex items-center gap-8 text-right group">
          <div className="space-y-1">
            <p className="text-4xl font-black text-white leading-none tracking-tighter group-hover:text-primary transition-colors">
              24H
            </p>
        ...
        <div className="flex items-center gap-8 text-right group">
          ...
          <div className="w-16 h-16 bg-white/5 rounded-2xl border border-white/10 flex items-center justify-center group-hover:border-primary/50 transition-all">
            <ArrowRightIcon
              weight="bold"
              className="text-primary w-7 h-7 -rotate-45"
            />
          </div>
        </div>
      </div>
